...
pub const SRTP_NULL_CIPHER: u32 = 0;
pub const SRTP_AES_ICM_128: u32 = 1;
pub const SRTP_AES_ICM_256: u32 = 5;
pub const SRTP_NULL_AUTH: u32 = 0;
pub const SRTP_HMAC_SHA1: u32 = 3;
...
pub type srtp_auth_type_pointer = *const srtp_auth_type_t;
...
>;
pub type srtp_cipher_decrypt_func_t = ::std::option::Option<
    unsafe extern "C" fn(
        state: *mut ::std::os::raw::c_void,
        buffer: *mut u8,
        octets_to_decrypt: *mut ::std::os::raw::c_uint,
    ) -> srtp_err_status_t,
>;
